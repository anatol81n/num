...
// node_modules/makel-dom/lib/index.js
var require_lib = __commonJS({
  "node_modules/makel-dom/lib/index.js"(exports) {
    ...
    function makel() {
      var querySelector = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "div";
      ...
      if (attributes) {
        attributes.forEach(function(item) {
          ...
          var _item$split = item.split("="), _item$split2 = _slicedToArray(_item$split, 2), label = _item$split2[0], value = _item$split2[1];
          if (value) {
...
//# sourceMappingURL=makel-dom.js.map
